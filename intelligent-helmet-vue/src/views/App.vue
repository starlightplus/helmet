...
import EventPanel from '@/components/terminal/EventPanel.vue'
import RideStatsPanel from '@/components/digital-twin/RideStatsPanel.vue'
import HelmetTwin from '@/components/digital-twin/HelmetTwin.vue'
import AiChat from '@/components/ai-ride/AiChat.vue'
import DataVisualization from '@/views/data-viz/DataVisualization.vue'
import RidePlan from '@/views/ai-ride/RidePlan.vue'
import DailyPlan from '@/views/ai-ride/DailyPlan.vue'
import TempHumidityCards from '@/components/terminal/TempHumidityCards.vue'
import AiAssistant from '@/components/ai-ride/AiAssistant.vue'
import { useWebSocket } from '@/composables/useWebSocket.js'
import { useRideTracking } from '@/composables/digital-twin/useRideTracking.js'
